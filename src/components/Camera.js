        ...
        return (
            <RectangleCopy>
                <CameraOn>
                    <span>CAMERA ON</span>
                    <div>
                        <img src={cameraon} className="img-responsive" alt="cameraon" />
                    </div>
                </CameraOn>
                <CameraOff>
                    <span>CAMERA OFF</span>
                    <div>
                        <img src={cameraon} className="img-responsive" alt="cameraoff" />
                    </div>
                </CameraOff>
                <CameraClear>
                    <span>CLEAR CAMERA</span>
                    <div>
                        <img src={cameraon} className="img-responsive" alt="cameraclear" />
                    </div>
                </CameraClear>
                <CardReset>
                    <span>RESET CARD</span>
                    <div>
                        <img src={cameraon} className="img-responsive" alt="card" />
                    </div>
                </CardReset>
            </RectangleCopy>
